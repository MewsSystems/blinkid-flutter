...
class BlinkIdCombinedRecognizerResult extends RecognizerResult {
  ...
  BlinkIdCombinedRecognizerResult(Map<String, dynamic> nativeResult)
    ...
    this.dataMatchDetailedInfo = nativeResult["dataMatchDetailedInfo"] != null
        ? DataMatchDetailedInfo(Map<String, dynamic>.from(nativeResult["dataMatchDetailedInfo"]))
        : null;
...
// Amount of countries defined by Mews:                                 251
