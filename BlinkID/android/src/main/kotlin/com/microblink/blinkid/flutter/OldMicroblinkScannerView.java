...
//
//
//class OldMicroblinkScannerView implements PlatformView, LifecycleOwner, MicroblinkScanner.Callbacks,
...
//     */
//    @SuppressLint("NewApi")
//    OldMicroblinkScannerView(@NonNull Context context, int id,
