...
OverlaySettings _$OverlaySettingsFromJson(Map<String, dynamic> json) => OverlaySettings(
...
Map<String, dynamic> _$OverlaySettingsToJson(OverlaySettings instance) => <String, dynamic>{
